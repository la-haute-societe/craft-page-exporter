...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/cp.js");
/******/ })
/************************************************************************/
/******/ ({
...
function () {
  ...
  _createClass(ShareButtonComponent, [{
    ...
    value: function init() {
      ...
      var btnShare = document.querySelector('.btn.sharebtn'); // Create btn
...
var shareButtonComponent = new ShareButtonComponent();
